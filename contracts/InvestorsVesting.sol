...
contract InvestorsVesting is IVesting, Ownable {
    ...
    /// @dev This method can be called only by distro contract
    ...
    function submit(
        ...
        require(start == 0, 'submit: Private Sale has Ended!');
    ...
    function claimTgeTokens() external override {
        ...
        cgtToken.mint(msg.sender, amount);
    ...
    function claimLockedTokens() external override {
        ...
        // Mint tokens to user address
        cgtToken.mint(msg.sender, availableAmount);
